...
export function HomePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <p className="text-gray-400 mb-6">Proyectos de diseño web premium</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-8">
        <input
          ...
          className="bg-gray-900 text-white border border-gray-700 rounded-lg px-4 py-2 focus:border-purple-500 focus:outline-none flex-1"
        />
        <select
          value={filter}
          onChange={e => setFilter(e.target.value)}
          className="bg-gray-900 text-white border border-gray-700 rounded-lg px-4 py-2 focus:border-purple-500 focus:outline-none"
        >
